...
const STAGES = ['INTAKE','OFFER_PROFILE','AVATAR_BUILD','COMPETITOR_DISCOVER','ADVERTORIAL_DISCOVER','ADVERTORIAL_FETCH','REVERSE_ENGINEER','REVERSE_BRIEF','COPY_CONCEPTS','ADVERTORIAL_DESIGN','ADVERTORIAL_COPY','CREATIVE_DIRECTION','AD_SCRIPTS','FUNNEL_BUILD','STATIC_ADS','VIDEO_DRAFT','VIDEO_FINAL','PERSONA_TEST','FEEDBACK_AGGREGATE','REVISION','QA_FINAL','DELIVERY']
